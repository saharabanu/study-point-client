...
const About = () => {
    return (
        <div className="container-fluid py-5" id="about">
            <h2 className="fs-1 fw-bolder py-4 about-header">About Us</h2>
            ...
            <div className="row p-1  ">
                ...
                <div className="col-12 col-lg-6 col-md-6 col-sm-12 p-3">
                    <iframe className="iframe-video" width="400" height="600" src="https://www.youtube.com/embed/Db7xzarI3B8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
